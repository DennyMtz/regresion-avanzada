...
wdir<-""
wdir<-"/home/denny/github/regresion-avanzada/codigo/m0-0"
setwd(wdir)
...
#-Defining inits-
inits<-function(){list(beta=rep(1,3),ypred=rep(1,n))}
...
#-Running code-
#OpenBUGS
poisson_0_0.sim<-bugs(data,inits,parameters,model.file="poisson_0-0.txt",
                  n.iter=20000,n.chains=1,n.burnin=5000)

out_poisson_0_0.sim <- poisson_0_0.sim$sims.list

traceplot(poisson_0_0.sim)
plot(poisson_0_0.sim)


#Resumen (estimadores)
#OpenBUGS
out.sum_poisson_0_0.sim <- poisson_0_0.sim$summary
#print(out.sum_poisson_0_0.sim)
head(out.sum_poisson_0_0.sim)
write.csv(out.sum_poisson_0_0.sim,"out.sum_poisson_0_0.sim.csv")
#DIC
poisson_0_0.sim.dic<-poisson_0_0.sim$DIC
print(poisson_0_0.sim.dic) #8.4e+11

out.ypred<-out.sum_poisson_0_0.sim [grep("ypred",rownames(out.sum_poisson_0_0.sim )),]
cor(datos$homi_count,out.ypred[,1])
#0.5296535

######################## Analisis MCMC para beta1
beta_num <- 1
z<-out_poisson_0_0.sim$beta[,beta_num]
par(mfrow=c(2,2))
plot(z,type="l")
...
############################3
#Predictions
out.ypred<-out.ypred<-out.sum_poisson_0_0.sim [grep("ypred",rownames(out.sum_poisson_0_0.sim )),]
